...
\begin{document}
    ...
    \section{I/O state}
        \subsection{Consistency flag (byte 64-66)}
        ...
        \begin{description}
            \item [$FF00_{16}$] Disk I/O stream was properly closed.
            \item [$FE01_{16}$] Disk I/O stream was not properly
    ...
    \section{Checksums}
        ...
        \begin{align*}
            p      &=      \texttt{7ed0e9fa0d94a33}_{16} \\
            f_1(x) &=      x \oplus (x \gg 32) \\
            f_2(x) &\equiv px \pmod{2^{64}} \\
            f(n)   &=      f_1(f_2(f_1(f_2(n))))
        \end{align*}
