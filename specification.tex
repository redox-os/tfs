...
\newcommand{\pagesize}{508 } % \clustersize - \clusterheader
...
\begin{document}
    ...
    \section{Clusters and pages}
        ...
        \begin{description}
            \item [8-bit cluster counter] This integer defines the number of
                free clusters stored in the data section.  Call this value $n$.
            \item [1 bytes for implementation defined usage] This is
